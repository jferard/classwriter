...
class ParsedFieldEncodedWriter(private val output: Writer,
                               private val attributeWritableFactory: ParsedAttributeEncodedWriter) :
        FieldEncodedWriter {
    ...
    companion object {
        fun create(output: Writer): ParsedFieldEncodedWriter {
            return ParsedFieldEncodedWriter(output,
                    ParsedAttributeEncodedWriter.create(output))
        }
    }
