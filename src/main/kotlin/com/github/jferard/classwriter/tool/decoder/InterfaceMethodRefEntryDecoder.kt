...
class InterfaceMethodRefEntryParser(private val classIndex: Short,
                                     private val nameAndTypeIndex: Short) :
        ConstantPoolEntryParser {
    override fun decode(
            entryViewerFactory: EntryViewerFactory): ConstantPoolEncodedEntryViewer {
        return entryViewerFactory!!.interfaceMethodRefEntryViewer(classIndex.toInt(),
