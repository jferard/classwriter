...
class MethodHandleEntryParser(private val referenceKind: Byte, private val referenceIndex: Short) :
        ConstantPoolEntryParser {
    override fun decode(
            entryViewerFactory: EntryViewerFactory): ConstantPoolEncodedEntryViewer {
        return entryViewerFactory!!.methodHandleEntryViewer(referenceKind, referenceIndex.toInt())
    }
