...
class FieldRefEntryParser(private val classIndex: Short, private val nameAndTypeIndex: Short) :
        ConstantPoolEntryParser {
    override fun decode(
            entryViewerFactory: EntryViewerFactory): ConstantPoolEncodedEntryViewer {
        return entryViewerFactory!!.fieldRefEntryViewer(classIndex.toInt(),
