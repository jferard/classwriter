...
class CodeAttributeAttributeParser(
    ...
    override fun parse(
        ...
        when (attributeName) {
            ...
            "LineNumberTable" -> return decodeLineNumberTable(attributeNameIndex, input)
            "LocalVariableTable" -> return decodeLocalVariableTable(attributeNameIndex, input)
            "LocalVariableTypeTable" -> return decodeLocalVariableTypeTable(attributeNameIndex,
                    input)
            else -> println(attributeName)
        }
    ...
    private fun decodeLocalVariableTable(attributeNameIndex: Int,
        ...
        return EncodeLocalVariableTableAttribute(attributeNameIndex,
                encodedLocalVariableTables)
    }
