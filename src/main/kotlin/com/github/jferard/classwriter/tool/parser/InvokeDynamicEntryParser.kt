...
class InvokeDynamicEntryParser(private val bootstrapMethodAttributeIndex: Short,
                               private val nameAndTypeIndex: Short) : ConstantPoolEntryParser {
    override fun decode(
            entryViewerFactory: EntryViewerFactory): ConstantPoolEncodedEntryViewer {
        return entryViewerFactory
                .invokeDynamicEntryViewer(bootstrapMethodAttributeIndex.toInt(),
