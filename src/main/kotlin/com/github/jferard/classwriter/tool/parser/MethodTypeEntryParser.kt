...
class MethodTypeEntryParser(private val descriptorIndex: Short) : ConstantPoolEntryParser {
    override fun decode(
            entryViewerFactory: EntryViewerFactory): ConstantPoolEncodedEntryViewer {
        return entryViewerFactory!!.methodTypeEntryViewer(descriptorIndex.toInt())
    }
