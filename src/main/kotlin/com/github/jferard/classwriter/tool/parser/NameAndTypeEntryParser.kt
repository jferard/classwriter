...
class NameAndTypeEntryParser(private val nameIndex: Short, private val descriptorIndex: Short) :
        ConstantPoolEntryParser {
    override fun decode(
            entryViewerFactory: EntryViewerFactory): ConstantPoolEncodedEntryViewer {
        return entryViewerFactory!!.nameAndTypeEntryViewer(nameIndex.toInt(),
                descriptorIndex.toInt())
    }
