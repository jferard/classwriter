...
class EncodedInstructions(private val codeLength: Long,
                          private val encodedInstructions: List<EncodedInstruction>) :
        Encoded<List<Instruction>, EncodedInstructions, InstructionEncodedWriter> {
    override fun write(encodedWriter: InstructionEncodedWriter) {
        throw NotImplementedError() //To change body of created functions use File | Settings | File Templates.
    }

    override fun decode(context: GlobalContext, codeContext: MethodContext): List<Instruction> {
        throw NotImplementedError() //To change body of created functions use File | Settings | File Templates.
    }
