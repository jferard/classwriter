...
/**
 * 4.1. The ClassFile Structure: cp_info
 */
interface EncodedConstantPoolEntry :
        Encoded<ConstantPoolEntry, EncodedConstantPoolEntry, ConstantPoolEntriesEncodedWriter> {
    fun utf8Text(): String
    fun toObject(): Any
}