 ...
 * Stack: () -> (value).
 */
class EncodedLLoadInstruction(private val referenceIndex: Int) :
        EncodedInstruction {
    override fun write(encodedWriter: InstructionEncodedWriter) {
        return encodedWriter.loadInstruction(OpCodes.LLOAD, referenceIndex)
    }
    ...
    override val size: Int = 2 * BytecodeHelper.BYTE_SIZE
