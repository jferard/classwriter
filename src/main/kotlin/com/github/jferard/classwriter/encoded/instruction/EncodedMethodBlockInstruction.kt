...
class EncodedMethodBlockInstruction(private val encodedInstructions: List<EncodedInstruction>) : EncodedInstruction {
    override fun write(encodedWriter: InstructionEncodedWriter) {
        return encodedWriter.methodBlockInstruction(encodedInstructions)
    }
