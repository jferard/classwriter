...
class EncodedLookupSwitchInstruction(private val defaultOffset: Int,
                                     private val match_and_offsets: IntArray) :
        EncodedInstruction {
    override fun write(encodedWriter: InstructionEncodedWriter) {
        return encodedWriter.lookupSwitchInstruction(defaultOffset, match_and_offsets)
    }
