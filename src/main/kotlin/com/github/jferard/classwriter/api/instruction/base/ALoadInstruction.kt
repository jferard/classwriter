...
import com.github.jferard.classwriter.encoded.instruction.EncodedALoadNInstruction
 ...
 * Stack: () -> (objectref).
 */
class ALoadInstruction(private val opcode: Int, private val index: Int) :
        BaseInstruction {
    override fun preprocess(context: GlobalContext,
        ...
        codeContext.assertTypeAssignable(VerificationType.REFERENCE, valueType)
