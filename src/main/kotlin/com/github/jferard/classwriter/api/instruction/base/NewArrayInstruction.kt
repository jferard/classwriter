...
import com.github.jferard.classwriter.encoded.instruction.EncodedNewArrayInstruction
...
class NewArrayInstruction(private val type: PrimitiveValueType) : BaseInstruction {
    override fun preprocess(context: GlobalContext,
        ...
        codeContext.stackPush(VerificationType.arrayFromPrimitiveType(type))
    }
