 ...
 */
class XAStoreInstruction(private val opcode: Int, private val verificationType: VerificationType) :
        BaseInstruction {
    override fun preprocess(context: GlobalContext,
        ...
        codeContext.assertTypeAssignable(verificationType, valueType)
