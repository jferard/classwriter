...
import com.github.jferard.classwriter.encoded.instruction.EncodedJsrInstruction
import com.github.jferard.classwriter.encoded.instruction.EncodedJsrWInstruction
...
class JsrInstruction(
    ...
    override fun preprocess(context: GlobalContext,
        ...
        codeContext.storeJsr(instruction)
        codeContext.addSubroutine(instruction)
    }
    ...
    override fun encode(context: GlobalContext,
        ...
        val branch: Long = codeContext.getSubroutineOffset(instruction)
        return if (branch <= BytecodeHelper.SHORT_MAX) {
            EncodedJsrInstruction(
                    branch.toInt())
        } else {
            EncodedJsrWInstruction(
                    branch)
        }
    }
