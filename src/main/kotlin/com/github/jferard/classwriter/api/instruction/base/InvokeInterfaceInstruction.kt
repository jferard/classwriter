...
import com.github.jferard.classwriter.encoded.instruction.EncodedInvokeInterfaceInstruction
...
class InvokeInterfaceInstruction(
        private val methodRef: MethodRef) : BaseInstruction {
    ...
    override fun encode(context: GlobalContext,
        ...
        val index: Int = context.addToPool(FieldRefEntry(methodRef))
        val count = methodRef.argsStackDepth
        return EncodedInvokeInterfaceInstruction(
                index, count)
    }
