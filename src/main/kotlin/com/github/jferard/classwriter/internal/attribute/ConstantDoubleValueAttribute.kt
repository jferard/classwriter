 ...
 * For a double.
 */
class ConstantDoubleValueAttribute internal constructor(private val value: Double) :
        ConstantFieldAttribute<ConstantDoubleValueAttribute> {
    override fun encode(pool: GlobalContext,
                        codeContext: MethodContext): EncodedConstantValueAttribute {
        val attributeNameIndex: Int =
                pool.addUtf8ToPool(ConstantValueAttributeFactory.CONSTANT_VALUE_NAME)
        val valueIndex: Int = pool.addToPool(DoubleEntry(value))
