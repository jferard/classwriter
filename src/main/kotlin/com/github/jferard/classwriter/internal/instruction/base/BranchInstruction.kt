 ...
 * Stack: (value1, value2) -> ().
 */
class BranchInstruction(private val opcode: Int, private val label: Label) :
        BaseInstruction {
...
// ?        codeContext.assertTypeEquals(VerificationType.INTEGER, codeContext.stackPop())
    ...
    override fun encode(context: GlobalContext,
        ...
        val branchIndex: Int = codeContext.getLabelOffset(label)
        return EncodedIndexedInstruction(opcode, branchIndex)
    }
