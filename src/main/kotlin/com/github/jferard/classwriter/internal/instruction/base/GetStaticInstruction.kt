 ...
 * Stack: () -> (value).
 */
class GetStaticInstruction(private val field: FieldRef) : BaseInstruction {
    ...
    override fun encode(context: GlobalContext,
        ...
        val index: Int = context.addToPool(FieldRefEntry(field))
        return EncodedIndexedInstruction(OpCodes.GETSTATIC, index)
    }
