...
class ConstantElementValue(private val o: Any) : ElementValue {
    ...
    override fun encode(context: GlobalContext,
        ...
        val tag: Int = ElementValueFactory.getTag(o)
        val elementValueIndex: Int = context.addToPool(ConstantPoolEntryFactory.create(o))
        return EncodedConstantElementValue(tag, elementValueIndex)
    }
