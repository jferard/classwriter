...
class Offsets(
        private val offsetByLabel: MutableMap<Label, Int>,
        private val offsetBySubroutine: MutableMap<Instruction, Int>,
        private val stackMapFrames: Stack<StackMapFrame>) {
    fun getLabelOffset(label: Label): Int {
        return offsetByLabel[label]!!
    }

    fun getSubroutineOffset(
            instruction: Instruction): Long {
        return offsetBySubroutine[instruction]!!.toLong()
    }

    fun getStackMapFrames(): Stack<StackMapFrame> {
