 ...
 */
class Dup2X1Instruction : BaseInstruction, EncodedInstruction {
    override fun preprocess(context: GlobalContext,
                            codeContext: MethodContext) {
        codeContext.offsetDelta(1)
        val value1Type: VerificationType = codeContext.stackPopOneByte()
        val value2Type: VerificationType = codeContext.stackPopOneByte()
        val value3Type: VerificationType = codeContext.stackPopOneByte()
    ...
    override fun write(encodedWriter: InstructionEncodedWriter) {
        return encodedWriter.dup2X1Instruction()
    }
