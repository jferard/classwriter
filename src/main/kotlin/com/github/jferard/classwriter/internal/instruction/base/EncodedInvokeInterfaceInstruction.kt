...
class EncodedInvokeInterfaceInstruction(private val index: Int, private val count: Int) :
        EncodedInstruction {
    override fun write(encodedWriter: InstructionEncodedWriter) {
        return encodedWriter.invokeInterfaceInstruction(index, count)
    }
    ...
    override val size: Int
        get() = BytecodeHelper.BYTE_SIZE + BytecodeHelper.SHORT_SIZE + 2 * BytecodeHelper.BYTE_SIZE
