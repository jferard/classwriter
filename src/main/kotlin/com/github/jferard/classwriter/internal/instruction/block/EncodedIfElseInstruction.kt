...
class EncodedIfElseInstruction(private val opcode: Int, private val encodedIf: EncodedInstruction,
                               private val encodedElse: EncodedInstruction) : EncodedInstruction {
