...
/**
 */
class ConstantLongValueAttribute internal constructor(private val value: Long) :
        ConstantFieldAttribute<ConstantLongValueAttribute> {
    override fun encode(context: GlobalContext,
        ...
        val valueIndex: Int = context.addToPool(LongEntry(value))
