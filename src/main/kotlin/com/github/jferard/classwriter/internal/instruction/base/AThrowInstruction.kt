 ...
 */
class AThrowInstruction : BaseInstruction, EncodedInstruction {
    ...
    override fun preprocess(context: GlobalContext,
        ...
        codeContext
                .assertTypeAssignable(VerificationType.REFERENCE,
                        codeContext.stackToTop())
    }
    ...
    override fun write(encodedWriter: InstructionEncodedWriter) {
        return encodedWriter.aThrowInstruction()
    }
