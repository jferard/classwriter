 ...
 * }</pre>
 */
public class EncodedChopFrame implements EncodedStackMapFrame {
    private final int k;
    private final int offsetDelta;

    public EncodedChopFrame(int k, int offsetDelta) {
        this.k = k;
    ...
    public Writable<?> toWritable(StackMapFrameWritableFactory<?> writableFactory) {
        return writableFactory.chopFrame(this.k, this.offsetDelta);
    }
