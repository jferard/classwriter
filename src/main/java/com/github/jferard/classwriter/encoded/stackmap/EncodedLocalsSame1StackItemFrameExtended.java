 ...
 * }</pre>
 */
public class EncodedLocalsSame1StackItemFrameExtended implements EncodedStackMapFrame {
    private final int offsetDelta;
    private final EncodedVerificationType encodedFirstStackItemVerificationType;

    public EncodedLocalsSame1StackItemFrameExtended(int offsetDelta,
    ...
    public Writable<?> toWritable(StackMapFrameWritableFactory<?> writableFactory) {
        return writableFactory.localsSame1StackItemFrameExtended(this.offsetDelta,
    ...
    public int getSize() {
        return BytecodeHelper.BYTE_SIZE + BytecodeHelper.SHORT_SIZE +
                encodedFirstStackItemVerificationType.getSize();
    }
}
