 ...
 * }</pre>
 */
public class EncodedSyntheticAttribute implements EncodedAttribute {
    private int attributeNameIndex;

    public EncodedSyntheticAttribute(int attributeNameIndex) {
        this.attributeNameIndex = attributeNameIndex;
    }

    @Override
    public Writable<?> toWritable(AttributeWritableFactory<?> writableFactory) {
        return writableFactory.syntheticAttribute(this.attributeNameIndex);
    }
