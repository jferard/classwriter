 ...
 */
public class EncodedFieldRefEntry implements EncodedConstantPoolEntry {
    private final int classIndex;
    private final int nameAndTypeIndex;

    public EncodedFieldRefEntry(int classIndex, int nameAndTypeIndex) {
    ...
    public Writable<?> toWritable(ConstantPoolEntriesWritableFactory<?> writableFactory) {
        return writableFactory.fieldRefEntry(this.classIndex, this.nameAndTypeIndex);
    }
