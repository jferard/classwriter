...
public class EncodedCode implements Encoded<InstructionWritableFactory<?>> {
    private List<EncodedInstruction> instructions;

    public EncodedCode(List<EncodedInstruction> instructions) {
        this.instructions = instructions;
    }

    @Override
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.code(this.instructions);
    }
