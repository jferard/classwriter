...
public class ByteCodeBootstrapMethod implements ByteCode {
    private final int methodRefIndex;
    private final List<Integer> argumentIndexes;

    public ByteCodeBootstrapMethod(int methodRefIndex, List<Integer> argumentIndexes) {
    ...
    public void write(DataOutput output) throws IOException {
        ...
        output.writeShort(this.argumentIndexes.size());
        for (Integer argumentIndex : this.argumentIndexes) {
            output.writeShort(argumentIndex);
        }
    }
}
