...
public class ByteCodeUninitializedOffsetVerificationType implements ByteCode {
    private int offset;

    public ByteCodeUninitializedOffsetVerificationType(int offset) {
        this.offset = offset;
    }
