...
public class ByteCodeNameAndTypeEntry implements ByteCode {
    private final int nameIndex;
    private final int descriptorIndex;

    public ByteCodeNameAndTypeEntry(int nameIndex, int descriptorIndex) {
    ...
    public void write(DataOutput output) throws IOException {
        output.writeByte(ConstantTags.NAMEANDTYPE);
