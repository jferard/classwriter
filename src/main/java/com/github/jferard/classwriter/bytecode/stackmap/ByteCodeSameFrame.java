...
public class ByteCodeSameFrame implements ByteCode {
    private int offsetDelta;

    public ByteCodeSameFrame(int offsetDelta) {
        this.offsetDelta = offsetDelta;
    }

    @Override
    public void write(DataOutput output) throws IOException {
        output.writeByte(StackMapFrameConstants.SAME_FRAME_BASE + this.offsetDelta);
    }
}
