...
public class ByteCodeBlockInstruction implements ByteCode {
    private List<ByteCode> writableInstructions;

    public ByteCodeBlockInstruction(List<ByteCode> writableInstructions) {
        this.writableInstructions = writableInstructions;
    }

    @Override
    public void write(DataOutput output) throws IOException {
        for (ByteCode writable : this.writableInstructions) {
