...
public class ByteCodeIndexedAttribute implements ByteCode {
    private final int attributeNameIndex;
    private final int entryIndex;

    public ByteCodeIndexedAttribute(int attributeNameIndex, int entryIndex) {
    ...
    public void write(DataOutput output) throws IOException {
        ...
        output.writeShort(this.entryIndex);
    }
}
