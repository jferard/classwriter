...
public class ByteCodeLocalsSame1StackItemFrame implements ByteCode {
    private final int offsetDelta;
    private final ByteCode writableFirstStackItemVerificationType;

    public ByteCodeLocalsSame1StackItemFrame(int offsetDelta,
    ...
    public void write(DataOutput output) throws IOException {
        output.writeByte(StackMapFrameConstants.SAME_LOCALS_1_STACK_ITEM_BASE + this.offsetDelta);
