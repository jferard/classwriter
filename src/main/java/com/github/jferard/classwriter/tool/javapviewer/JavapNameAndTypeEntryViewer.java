...
class JavapNameAndTypeEntryViewer implements ConstantPoolEncodedEntryViewer {
    private final int nameIndex;
    private final int descriptorIndex;

    public JavapNameAndTypeEntryViewer(int nameIndex, int descriptorIndex) {
    ...
    public String view(List<ConstantPoolEncodedEntryViewer> entries, int i) {
        return String.format(JavapEntryViewerFactory.NUM_FORMAT +
                ...
                "NameAndType",
                "#" + this.nameIndex + ":#" + this.descriptorIndex, this.viewSummary(entries));
    }
    ...
    public String viewSummary(List<ConstantPoolEncodedEntryViewer> entries) {
        return entries.get(this.nameIndex).viewSummary(entries) + ":" +
                entries.get(this.descriptorIndex).viewSummary(entries);
    }
}
