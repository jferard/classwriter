...
public class EncodeLocalVariableTypeTableAttribute implements EncodedCodeAttributeAttribute {
    private final int attributeNameIndex;
    private final List<EncodedLocalVariableTypeTable> encodedLocalVariableTables;

    public EncodeLocalVariableTypeTableAttribute(int attributeNameIndex,
                                                 List<EncodedLocalVariableTypeTable> encodedLocalVariableTables) {
