...
class JavapUTF8EntryViewer implements ConstantPoolEncodedEntryViewer {
    private final String text;

    public JavapUTF8EntryViewer(String text) {
        this.text = text;
    }
    ...
    public String view(List<ConstantPoolEncodedEntryViewer> entries, int i) {
        return String.format(JavapEntryViewerFactory.NUM_FORMAT +
                        JavapEntryViewerFactory.CODE_FORMAT + "%s", "#" + i, "Utf8",
                this.text);
    }
