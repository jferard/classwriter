...
public class ByteMethodAttributeViewerFactory implements MethodAttributeViewerFactory {
    @Override
    public MethodAttributeViewer code() {
        return new ByteCodeMethodAttributeViewer();
    }
}
