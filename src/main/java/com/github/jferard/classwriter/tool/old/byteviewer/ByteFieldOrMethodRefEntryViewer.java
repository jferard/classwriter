...
class ByteFieldOrMethodRefEntryViewer implements ConstantPoolEncodedEntryViewer {
    private final String code;
    private final int classIndex;
    private final int nameAndTypeIndex;

    public ByteFieldOrMethodRefEntryViewer(String code, int classIndex, int nameAndTypeIndex) {
        this.code = code;
