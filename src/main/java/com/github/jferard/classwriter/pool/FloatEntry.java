...
public class FloatEntry implements ConstantPoolEntry, EncodedConstantPoolEntry {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FloatEntry)) return false;

        FloatEntry other = (FloatEntry) o;
    ...
    public Writable<?> toWritable(ConstantPoolEntriesWritableFactory<?> writableFactory) {
        return writableFactory.floatEntry(this.value);
    }

    @Override
    public int getSize() {
        return BytecodeHelper.BYTE_SIZE + BytecodeHelper.FLOAT_SIZE;
    }
