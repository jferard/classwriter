 ...
 * 4.4.1 -> 4.4.10
 */
public interface ConstantPoolEntry extends Encodable<EncodedConstantPoolEntry> {
    int addToPool(GlobalContext constantPool);
    ...
    VerificationType toVerificationType();
}
