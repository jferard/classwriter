...
public class EncodedLdcWInstruction implements EncodedInstruction {
    private final int index;

    public EncodedLdcWInstruction(int index) {
        this.index = index;
    }

    @Override
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.ldcWInstruction(this.index);
    }
