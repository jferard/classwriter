...
public class InvokeDynamicInstruction implements BaseInstruction {
    private final MethodRef methodRef;

    public InvokeDynamicInstruction(MethodRef methodRef) {
    ...
    public EncodedInstruction encode(GlobalContext context, MethodContext codeContext) {
        ...
        return new EncodedInvokeDynamicInstruction(index);
    }
}
