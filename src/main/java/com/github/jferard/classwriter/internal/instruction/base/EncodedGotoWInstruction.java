...
public class EncodedGotoWInstruction implements EncodedInstruction {
    private final int branch;

    public EncodedGotoWInstruction(int branch) {
        this.branch = branch;
    }

    @Override
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.gotoWInstruction(this.branch);
    }
