...
public class WideRetInstruction implements BaseInstruction, EncodedInstruction {
    private final int index;

    public WideRetInstruction(int index) {
        this.index = index;
    }
    ...
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.wideRetInstruction(index);
    }
