...
import com.github.jferard.classwriter.bytecode.instruction.ByteCodeOneByteInstruction;
 ...
 */
public class AThrowInstruction implements BaseInstruction, EncodedInstruction {
    @Override
    ...
    public void preprocess(GlobalContext context, MethodContext codeContext) {
        ...
        codeContext
                .assertTypeAssignable(VerificationType.REFERENCE, codeContext.stackToTop());
    }

    @Override
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return new ByteCodeOneByteInstruction(OpCodes.ATHROW);
    }
