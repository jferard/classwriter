 ...
 * Stack: () -> (null).
 */
public class ConstInstruction implements BaseInstruction, EncodedInstruction {
    private final int opcode;
    private final VerificationType verificationType;

    public ConstInstruction(int opcode, VerificationType verificationType) {
        this.opcode = opcode;
    ...
    public void preprocess(GlobalContext context, MethodContext codeContext) {
        ...
        codeContext.stackPush(this.verificationType);
    }
    ...
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.constInstruction(this.opcode);
    }
