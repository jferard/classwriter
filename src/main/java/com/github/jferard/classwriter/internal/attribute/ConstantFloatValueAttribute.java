 ...
 * For a float.
 */
public class ConstantFloatValueAttribute implements FieldAttribute {
    private final float value;

    ConstantFloatValueAttribute(float value) {
        this.value = value;
    }
    ...
    public EncodedFieldAttribute encode(GlobalContext pool, MethodContext codeContext) {
        ...
        int valueIndex = pool.addToPool(new FloatEntry(this.value));
