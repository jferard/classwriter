...
public class UnaryInstruction implements BaseInstruction, EncodedInstruction {
    private final int opcode;

    public UnaryInstruction(final int opcode) {
        this.opcode = opcode;
    }
    ...
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.unaryInstuction(this.opcode);
    }
