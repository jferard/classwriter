 ...
 */
public class BiPushInstruction implements BaseInstruction, EncodedInstruction {
    private final byte b;

    public BiPushInstruction(byte b) {
        this.b = b;
    }
    ...
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.biPushInstruction(this.b);
    }
