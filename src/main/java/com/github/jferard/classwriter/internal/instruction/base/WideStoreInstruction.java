...
public class WideStoreInstruction implements BaseInstruction, EncodedInstruction {
    private final int opcode;
    private final int index;

    public WideStoreInstruction(int opcode, int index) {
        this.opcode = opcode;
        this.index = index;
    }
    ...
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.wideStoreInstruction(opcode, index);
    }
