...
public class AStoreInstruction
        implements BaseInstruction, EncodedInstruction {
    private final int opcode;
    private final VerificationType verificationType;

    public AStoreInstruction(int opcode, VerificationType verificationType) {
        this.opcode = opcode;
    ...
    public void preprocess(GlobalContext context, MethodContext codeContext) {
        ...
        codeContext.assertTypeAssignable(this.verificationType, valueType);
        ReferenceVerificationType componentType = codeContext.assertIsArray(arrayType);
        codeContext.assertTypeAssignable(componentType, valueType);
    }
    ...
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.aStoreInstruction(this.opcode);
    }
