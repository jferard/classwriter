...
public class MockLabelInstruction implements BaseInstruction, EncodedInstruction {
    private final Label label;

    public MockLabelInstruction(Label label) {
        this.label = label;
    }

    @Override
    public void preprocess(GlobalContext context, MethodContext codeContext) {
        codeContext.storeLabel(this.label);
    }
