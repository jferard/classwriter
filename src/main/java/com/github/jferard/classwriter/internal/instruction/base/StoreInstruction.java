...
public class StoreInstruction implements BaseInstruction, EncodedInstruction {
    private final int opcode;
    private final int index;

    public StoreInstruction(int opcode, int index) {
        this.opcode = opcode;
        this.index = index;
    }
    ...
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.storeInstruction(opcode, index);
    }
