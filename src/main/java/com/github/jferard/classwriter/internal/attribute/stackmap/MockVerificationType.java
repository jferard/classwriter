...
public class MockVerificationType implements VerificationType {
    private final boolean isLong;
    private final VerificationType parent;

    public MockVerificationType(boolean isLong, VerificationType parent) {
        this.isLong = isLong;
        this.parent = parent;
    }
