...
public class ReturnInstruction implements BaseInstruction, EncodedInstruction {
    ...
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.returnInstruction(this.opcode);
    }
