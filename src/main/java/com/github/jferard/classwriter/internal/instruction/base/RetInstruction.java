...
public class RetInstruction implements BaseInstruction, EncodedInstruction {
    private final int index;

    public RetInstruction(int index) {
        this.index = index;
    }
    ...
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.retInstruction(this.index);
    }
