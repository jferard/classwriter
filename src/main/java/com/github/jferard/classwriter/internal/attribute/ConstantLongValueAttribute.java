...
/**
 */
public class ConstantLongValueAttribute implements FieldAttribute {
    private final long value;

    ConstantLongValueAttribute(long value) {
        this.value = value;
    }
    ...
    public EncodedFieldAttribute encode(GlobalContext pool, MethodContext codeContext) {
        ...
        int valueIndex = pool.addToPool(new LongEntry(this.value));
