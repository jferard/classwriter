...
public class EncodedInvokeDynamicInstruction implements EncodedInstruction {
    private final int index;

    public EncodedInvokeDynamicInstruction(int index) {
        this.index = index;
    }

    @Override
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.invokeDynamicInstruction(this.index);
    }
