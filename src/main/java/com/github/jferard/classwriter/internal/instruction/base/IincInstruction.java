 ...
 */
public class IincInstruction implements BaseInstruction, EncodedInstruction {
    private final int index;
    private final int c;

    public IincInstruction(int index, int c) {
        this.index = index;
        this.c = c;
    }
    ...
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.iincInstruction(index, c);
    }

    @Override
    public int getSize() {
        return 3 * BytecodeHelper.BYTE_SIZE;
    }
}
