...
public class MockLineNumberInstruction implements BaseInstruction, EncodedInstruction {
    private final int lineNumber;

    public MockLineNumberInstruction(int lineNumber) {
        this.lineNumber = lineNumber;
    }

    @Override
    public void preprocess(GlobalContext context, MethodContext codeContext) {
        codeContext.storeLineNumber(this.lineNumber);
    }
