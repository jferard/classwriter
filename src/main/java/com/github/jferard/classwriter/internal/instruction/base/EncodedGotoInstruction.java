...
public class EncodedGotoInstruction implements EncodedInstruction {
    private final int branch;

    public EncodedGotoInstruction(int branch) {
        this.branch = branch;
    }

    @Override
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.gotoInstruction(this.branch);
    }
