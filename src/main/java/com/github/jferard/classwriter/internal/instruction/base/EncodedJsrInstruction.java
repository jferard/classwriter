...
public class EncodedJsrInstruction implements EncodedInstruction {
    private final int branch;

    public EncodedJsrInstruction(int branch) {
        this.branch = branch;
    }

    @Override
    public Writable<?> toWritable(InstructionWritableFactory<?> writableFactory) {
        return writableFactory.jsrInstruction(this.branch);
    }
