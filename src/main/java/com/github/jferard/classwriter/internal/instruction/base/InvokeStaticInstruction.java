 ...
 */
public class InvokeStaticInstruction implements BaseInstruction {
    private final MethodRef methodRef;
    private final int opcode;

    public InvokeStaticInstruction(final int opcode, MethodRef methodRef) {
        this.opcode = opcode;
    ...
    public void preprocess(GlobalContext context, MethodContext codeContext) {
        ...
        codeContext.stackPush(VerificationType.fromValueType(this.methodRef.getRetType()));
    }
