...
public class ObjectVerificationType implements VerificationType {
    private FieldDescriptor descriptor;

    public ObjectVerificationType(FieldDescriptor descriptor) {
        this.descriptor = descriptor;
    }

    @Override
    public EncodedVerificationType encode(GlobalContext context, MethodContext codeContext) {
        int classIndex = context.addToPool(this.descriptor.toPoolEntry());
        return new EncodedObjectVerificationType(classIndex);
    }
